...
"""
    ...
    AmlBitcoin should be started with the command line arguments:
        AmlBitcoind -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND AML issuance at " + str(pos))
				print("After AML: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND AML something at " + str(pos))
			start += pos+8
			print(astr)
