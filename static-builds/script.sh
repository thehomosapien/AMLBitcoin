...
find ${DISTNAME}/bin -type f -executable -exec ../AmlBitcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../AmlBitcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/AmlBitcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/AmlBitcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
