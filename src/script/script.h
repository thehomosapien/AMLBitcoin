...
#ifndef AMLBITCOIN_SCRIPT_SCRIPT_H
#define AMLBITCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, AmlBitcoin always counted CHECKMULTISIGs
...
#endif // AMLBITCOIN_SCRIPT_SCRIPT_H
