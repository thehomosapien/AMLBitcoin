...
#ifndef AMLBITCOIN_CHAINPARAMS_H
#define AMLBITCOIN_CHAINPARAMS_H
 ...
 * AmlBitcoin system. There are three: the main network on which people trade goods
...
#endif // AMLBITCOIN_CHAINPARAMS_H
