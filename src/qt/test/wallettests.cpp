...
#include "qt/AmlBitcoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<AmlBitcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_AmlBitcoin-qt -platform xcb      # Linux
//     src/qt/test/test_AmlBitcoin-qt -platform windows  # Windows
//     src/qt/test/test_AmlBitcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = AmlBitcoinUnits::formatWithUnit(unit, balance, false, AmlBitcoinUnits::separatorAlways);
    ...
    // Amount input
    AmlBitcoinAmountField* amountInput = receiveCoinsDialog.findChild<AmlBitcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: AmlBitcoin:")) != -1);
