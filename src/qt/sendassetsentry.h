...
#ifndef AMLBITCOIN_QT_SENDASSETSENTRY_H
#define AMLBITCOIN_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending AmlBitcoins.
...
#endif // AMLBITCOIN_QT_SENDASSETSENTRY_H
