...
#ifndef AMLBITCOIN_QT_GUIUTIL_H
#define AMLBITCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the AmlBitcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "AmlBitcoin:" URI into recipient object, return true on successful parsing
