...
#ifndef AMLBITCOIN_QT_OPTIONSMODEL_H
#define AMLBITCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for AmlBitcoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // AmlBitcoinUnits::Unit
...
#endif // AMLBITCOIN_QT_OPTIONSMODEL_H
