...
#ifndef AMLBITCOIN_QT_AMLBITCOINGUI_H
#define AMLBITCOIN_QT_AMLBITCOINGUI_H
...
/**
  AmlBitcoin GUI main class. This class represents the main window of the AmlBitcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AmlBitcoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AmlBitcoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~AmlBitcoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a AmlBitcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
#endif // AMLBITCOIN_QT_AMLBITCOINGUI_H
