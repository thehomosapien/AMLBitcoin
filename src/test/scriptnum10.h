...
#ifndef AMLBITCOIN_TEST_SCRIPTNUM10_H
#define AMLBITCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from AmlBitcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // AMLBITCOIN_TEST_BIGNUM_H
