...
#ifndef AMLBITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define AMLBITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // AMLBITCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
