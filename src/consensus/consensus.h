...
#ifndef AMLBITCOIN_CONSENSUS_CONSENSUS_H
#define AMLBITCOIN_CONSENSUS_CONSENSUS_H
...
static const int COINBASE_MATURITY = 239;
...
#endif // AMLBITCOIN_CONSENSUS_CONSENSUS_H
