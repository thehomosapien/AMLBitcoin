...
This document provides guidelines for internationalization of the AmlBitcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `AmlBitcoin_en.ts` remains unchanged.
