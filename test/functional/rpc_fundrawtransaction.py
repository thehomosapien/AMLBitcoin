...
class RawTransactionsTest(AmlBitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid AmlBitcoin address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        # output 0 takes at least as much share of the fee, and no more than 2 AmlBits more, than outputs 2 and 3
