...
class AssetTest(AmlBitcoinTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating AML for node[0] and activating assets...")
    ...
    def big_test(self):
        ...
        n0.issue("AMLBITCOIN1", 1000)
        n0.issue("AMLBITCOIN2", 1000)
        n0.issue("AMLBITCOIN3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="AMLBITCOIN*", verbose=False, count=2, start=-2)
        ...
        AmlBitcoin_assets = n0.listassets(asset="AMLBITCOIN*", verbose=False, count=2, start=-2)
        assert_equal(len(AmlBitcoin_assets), 2)
        assert_equal(AmlBitcoin_assets[0], "AMLBITCOIN2")
        assert_equal(AmlBitcoin_assets[1], "AMLBITCOIN3")
        self.sync_all()
