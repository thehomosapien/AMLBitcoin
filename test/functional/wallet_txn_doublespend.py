...
class TxnMallTest(AmlBitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 AML:
        ...
        # First: use raw transaction API to send 1240 AML to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 AML coin each
        ...
        # Node0's balance should be starting balance, plus 50AML for another
        ...
        # Node0's total balance should be starting balance, plus 100AML for 
