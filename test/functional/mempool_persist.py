...
By default, AmlBitcoind will dump mempool on shutdown and
...
class MempoolPersistTest(AmlBitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give AmlBitcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent AmlBitcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
