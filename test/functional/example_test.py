...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AmlBitcoinTestFramework
    pass

class ExampleTest(AmlBitcoinTestFramework):
    # Each functional test is a subclass of the AmlBitcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        AmlBitcoinTestFramework class so other tests can use it."""
