...
from test_framework.test_framework import AmlBitcoinTestFramework, SkipTest
...
class ZMQTest (AmlBitcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that AmlBitcoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("AmlBitcoind has not been built with zmq enabled.")
