...
class BIP66Test(AmlBitcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # AmlBitcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and AmlBitcoind produces more specific reject
            # reasons.
